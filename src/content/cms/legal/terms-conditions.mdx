...
meta:
  title: Terms & conditions
  description: >-
    Copyright (c) 2020 Quocs, Ho Chi Minh City, VIETNAM
    ("we", "us", "our"). The code of this website is licensed under the MIT
    License. The website uses [open-source
    software](https://github.com/quocs-studio/site/blob/master/package.json).
  permalink: /legal/terms/
  ogImage: /assets/og.png
---

1.  General:
    1. By accessing the website at [https://www.quocs.com](/) and its associated services (the "Website"), you are agreeing to be bound by these terms of service, all applicable laws and regulations, and agree that you are responsible for compliance with any applicable local laws. If you do not agree with any of these terms, you are prohibited from using or accessing this site. The materials contained in this Website are protected by applicable copyright and trademark law.
1.  Use License:
